...
\begin{itemize}
    \item Bootstrapping, proces smanjivanja \v suma
...
\begin{itemize}
    \item Kreirati efikasniji kriptosistem (\v sto manje overhead-a za bootstrapping)
...
\begin{itemize}
    ...
    \item Poznate FHE \v seme se dobijaju od SHE \v sema procesom bootstrappinga
    \item Uveli smo \v semu DGHV kao SHE
    \item Klju\v cna ideja bootstrappinga je vr\v senje algoritma dekripcije homomorfno u \v sifrovanom domenu
