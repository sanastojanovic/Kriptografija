...
\begin{frame}{Pragovne (threshold) strukture}
...
\item Opisati problem deljenja tajni i objasniti kako se tajna distribuira među učesnicima.
 
\item Kako se tajna rekonstruiše u Šamirovoj šemi i koji matematički postupak se koristi?
 
\item Objasniti vezu između stepena polinoma i minimalnog broja učesnika potrebnih za rekonstrukciju tajne u Šamirovoj šemi.
\end{enumerate}
\end{frame}
