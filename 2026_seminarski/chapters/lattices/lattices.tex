...
\section{Pitanja}
\begin{enumerate}
    \item Na čemu se zasniva bezbednost kriptografskih sistema koji se danas koriste i da li je ona ugrožena? Ako jeste ugrožena, navesti zašto.
    \item Kako se definišu rešetke? Koji problemi se smatraju teški na rešetkama?
    \item Šta je tajni, a šta javni ključ u osnovnom obliku NTRU kriptosistema?
